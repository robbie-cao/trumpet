...
// -------------------------------------------------------------------------------------------------------------------------------
#define MIDI_POLYPHONY_NUM				2			// The polyphonies can be played at the same time
#define MIDI_FIFIO_BUF_SIZE				64			// The buffer size to keep MIDI commands
#define MIDI_SAMPLE_RATE				12000*2		// The output sampling rate for MIDI decoding
#define MIDI_DECODE_SAMPLE_PER_FRAME	16			// The decoded PCM samples at each calling MIDISynthEx_DecodeProcess()
#define MIDI_CH_VOLUME					5			// Range of channel volume is in 0~127. 0 is mute.

// -------------------------------------------------------------------------------------------------------------------------------
// Configuration: PCM Ring Buffer
// -------------------------------------------------------------------------------------------------------------------------------
#define MIDIEXAPP_OUT_FRAME_NUM	  				4		// it can be : 2, 3, 4, 5, ....
...
//  	u32StartAddr[in] :
//?		Start address of playback midi.
//		u32DataSize[in] :
//?		Total size of playback midi.
