...
Purpose:
---------------------------------------------------------------------------------------------------------
	1. 	Demo how to input sound from microphone and then output 2 channels with pitch shifting (higher and lower) to get harmony sound effect.
...
---------------------------------------------------------------------------------------------------------
	LED:
		...
		2. 	GPA15: channel 0 (pitch shifted up 3 semitones)is enabled.
		3. 	GPB5:  channel 1 (pitch shifted down 3 semitones)is enabled.

	Key:
		1. 	GPB0: enable / disable channel 0 (pitch shifted up 3 semitones).
		2. 	GPB1: enable / disable channel 1 (pitch shifted  down 3 semitones).
...
Note:
---------------------------------------------------------------------------------------------------------
	1. 	Pitch shift too much will cause too much distortion.
	2.  	If mix original sound may cause feedback howl noise.
	3.  	More channels consume more RAM and MIPS.
