...
// -------------------------------------------------------------------------------------------------------------------------------
#include "HarmonySndApp/HarmonySndApp.h"
...
typedef struct
{
	S_HARMONYSNDAPP	sHarmonySndApp;		// harmony sound app work data

	UINT16 			u16ChannelEnabled;	// harmony channel enable / disable flag
} S_APP;
