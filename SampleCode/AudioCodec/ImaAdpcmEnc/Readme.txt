...
Purpose:
---------------------------------------------------------------------------------------------------------
	1. 	Record encoded data with ImaAdpcm encoder to SPIFlash .
	2.	Play decoded data with ImaAdpcm decoder from SPIFlash.
...
Must Know:
---------------------------------------------------------------------------------------------------------
	1.	The stack size is defined bye "Stack_Size" in "startup_ISD9100.s". Can change the stack size
