...
uint32_t CLK_GetHIRCFreq(void)
{
	return gau32HiRCSrcTbl[(((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 & (0x1ul << (6)))>>(6)];
}
...
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32HIRCType, uint32_t u32ClkDiv)
{
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 & ~((0x7ul << (0))|(0x1ul << (6)))) | u32ClkSrc | u32HIRCType;
...
void CLK_DeepPowerDown(uint32_t u32DPDWakeupMode, uint32_t u32TimerSel)
{
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCTL &= 0xFF0000FF;		
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCTL |= 0x1ul << (11); 
	
	
	
	
	
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCTL |= u32TimerSel << (20);	 
	...
	switch(u32DPDWakeupMode)
	{
		...
		case 1:		                              
			((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCTL |= 0x1ul << (17);   
			break;

		case 2:	                            
 			((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCTL |= 0x1ul << (16);    
			break;
			
		case 3:          	
		    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCTL |= ((0x1ul << (17))|(0x1ul << (16)));    
		    break;
...
void CLK_StandbyPowerDown(void)
{
	...
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (1UL << 2);	
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCTL &= 0xFF0000FF;		
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCTL |= 0x1ul << (10); 
...
void CLK_DeepSleep(void)
{
	...
	((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (1UL << 2);	
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCTL &= 0xFF0000FF;		
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCTL |= 0x1ul << (9);  
...
void CLK_EnableLDO( uint32_t u32LDOSel )
{
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK0 |= (0x1ul << (30));
	((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->LDOPD &= ~(0x1ul << (0));
	((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->LDOSEL = (((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->LDOSEL&~(0x3ul << (0)))|u32LDOSel; 
