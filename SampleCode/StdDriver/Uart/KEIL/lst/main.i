...
void SYS_Init(void)
{
    ...
    CLK_SetHCLK((0x00UL<<(0)), (0x00UL<<(6)), (((1)-1) << (0)));

     
    CLK_EnableModuleClock(((1UL<<30)|(0<<28)|(0x0<<25)|( 0<<20)|(0<<18)|( 0xF<<10)|( 8<<5)|(16)));
	...
	((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP  = (((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP & (~(0x3ul << (16))) ) | (0x1UL<<(16));
	((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP  = (((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP & (~(0x3ul << (18))) ) | (0x1UL<<(18));
...
int main(void)
{
	...
	while(1)
	{
		...
		if( UART_Read( ((UART_T *) ((( uint32_t)0x40000000) + 0x50000)), u8Buffer, sizeof(u8Buffer) ) > 0 )
			UART_Write( ((UART_T *) ((( uint32_t)0x40000000) + 0x50000)), u8Buffer, sizeof(u8Buffer) );
	}
}
