...
#line 7 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\ISD9100\\Source\\system_ISD9100.c"
...
#line 8 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\ISD9100\\Source\\system_ISD9100.c"



 
uint32_t SystemCoreClock = ((49152000UL));                           
uint32_t CyclesPerUs = (((49152000UL)) / 1000000);                   
uint32_t gau32ClkSrcTbl[] = {(49152000UL), (32768UL), (16000UL)};                
uint32_t gau32HiRCSrcTbl[] = {(49152000UL), 32768000};            
...
void SystemCoreClockUpdate (void)                           
{
    ...
    u32ClkSrc = gau32ClkSrcTbl[(((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 & (0x7ul << (0)))];

    if(u32ClkSrc == (49152000UL))
    {
         
        u32ClkSrc = gau32HiRCSrcTbl[(((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 & (0x1ul << (6)))>>(6)];
    } 
