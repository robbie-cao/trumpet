...
#define APU_FILTER_ENABLE				(1)		// 0: disable, 1:enable SW NuDAC low pass filter, 2:enable HW biquad filter,
...
// -------------------------------------------------------------------------------------------------
#define CONFIG_MATRIX_KEY			(1)	// 1: enable matrix key, 0: disable matrix key
