...
// APU Enable Options 
// -------------------------------------------------------------------------------------------------------------------------------
#define APU_ENABLE						(0)		// 1:enable APU, 0:disable APU	
#define APU_FILTER_ENABLE				(0)		// 0: disable, 1:enable SW NuDAC low pass filter, 2:enable HW biquad filter,
#define APU_PDMA_ENABLE 				(0)		// 1:enable HW PDMA to handle dpwm input data, 0: Software scheme
...
#define CONFIG_OUTPUT_PIN      			(0)     // 1: enable output key, 0: disable output key
...
#define ULTRAIO_FW_TMR        		  	(1)     // 0:Set TIMER0 is used for FW pwm, 1:Set TIMER1 is used for FW pwm, 2:Set TIMER2 is used for FW pwm.


#define CONFIG_TOUCH_KEY     		 	(0)     // 1: enable trigger key, 0: disable trigger  key
